<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_FutherStudy.aspx.cs" Inherits="WebApplication1.Update_FutherStudy" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <x:Panel ID="Panel2" runat="server" Height="460px" ShowBorder="True" EnableCollapse="true"
                            ...
                            <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DropDownList AutoPostBack="false" EnableSimulateTree="true" ShowLabel="false" TabIndex ="5"
                                          ...
                                          <x:ListItem Text="居民身份证" Value="居民身份证" />
                                            <x:ListItem Text="护照" Value="护照" />
                                             <x:ListItem Text="其他" Value="其他" />
                                        </x:DropDownList>
                                </Items>
                            </x:Panel>
                        ...
                        <Items>
                            ...
                            <x:Panel ID="Panel16" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DatePicker ID="dLearnBeginTime" runat="server" Width="150px" EnableEdit="false" Label="进修开始时间" Required="true" TabIndex="11">
                                    </x:DatePicker>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel17" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DatePicker ID="dLearnEndTime" runat="server" Width="150px" EnableEdit="false" Label="进修结束时间"  TabIndex="12">
                                    </x:DatePicker>
                                </Items>
                            </x:Panel>
