<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateFurniture.aspx.cs" Inherits="WDFramework.FixedAssets.Furniture.UpdateFurniture1" %>
                        ...
                        <x:Panel ID="Panel3" Title="项目概要" runat="server" ColumnWidth="100%" ShowBorder="false" BodyPadding="30px"
                            ...
                            <Items>
                                <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        <x:Label ID="MissionName2" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="家具名：">
                                        </x:Label>
                                        <x:TextBox ID="tb_FurnitureName" Label="家具名" AutoPostBack="true" ShowLabel="true" Width="200px"
                           ...
                           <x:Label ID="Label13" runat="server" Label="Label" Text=" " Height="20px">
                            ...
                            <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="存放地点" ID="tb_StorageLocation" Width="255px"  MaxLength="100" TabIndex="3" AutoPostBack="true" >
                                    </x:TextBox>
                            ...
                            <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="购买人" ID="tb_Purchase" Width="255px"  MaxLength="50" MaxLengthMessage="最多可输入50个字符" TabIndex="4" AutoPostBack="true" >
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel7" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="使用人" ID="tb_UsePerson" Width="255px"  MaxLength="50" MaxLengthMessage="最多可输入50个字符" TabIndex="6" AutoPostBack="true" >
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel8" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    <x:Label ID="Label8" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="购置日期：">
                                        ...
                                        <x:DatePicker ID="dp_PurchaseTime" runat="server" ShowLabel="true" EnableEdit="false" Label="购置日期" Width="250px" TabIndex="7">
                                    </x:DatePicker>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="价格" ID="tb_price" Width="245px"  MaxLength="20" MaxLengthMessage="最多可输入20个字符" TabIndex="8" AutoPostBack="true" >
                                    </x:TextBox>
                            ...
                            <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="计量单位" ID="tb_MeasurementUnit" Width="255px"  MaxLength="30" TabIndex="9" AutoPostBack="true" >
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel15" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="生产厂家" ID="tb_Manufacturer" Width="255px"  MaxLength="30" TabIndex="10" AutoPostBack="true" >
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel16" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="型号" ID="tb_Model" Width="255px"  MaxLength="30" TabIndex="11" AutoPostBack="true" >
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel17" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="分类号" ID="tb_ClassNum" Width="255px"  MaxLength="30" MaxLengthMessage="最多可输入30个字符" TabIndex="12" AutoPostBack="true" >
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel19" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="备注" ID="tb_Remarks" Width="255px"  MaxLength="100" MaxLengthMessage="最多可输入100个字符" TabIndex="15" AutoPostBack="true" >
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
