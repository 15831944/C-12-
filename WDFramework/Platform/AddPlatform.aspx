<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPlatform.aspx.cs" Inherits="WDFramework.Platform.AddPlatform" %>
...
<body oncontextmenu='return false'>
    ...
    <form id="form1" runat="server">
                            ...
                            <Items>
                                <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="txtPlatformName" Label="平台名称" MaxLength="50" MaxLengthMessage="最多输入50个字符" ShowLabel="true"
                                ...
                                <x:Panel ID="Panel6" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" Label="平台级别" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex="2"
                                ...
                                <x:Panel ID="Panel1" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" Label="批复部门" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex="3"
                                ...
                                <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker ID="DatePicker_AgreeTime" runat="server" Width="195px" ShowLabel="true" Label="批复日期" Required="true" EnableEdit="false" TabIndex="4">
                                ...
                                <x:Panel ID="Panel8" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="txtAgreeNumber" Label="批复文号" MaxLength="50" MaxLengthMessage="最多输入20个字符" ShowLabel="true"
                                ...
                                <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                    <Items>
                                        <x:Label ID="Label9" Width="60px" CssStyle="text-align:right" runat="server" CssClass="marginr" ShowLabel="false" Text="批复">
                                        </x:Label>
                                        <x:Label ID="labAgreeExpenditure" Width="80px" runat="server" CssClass="marginr" ShowLabel="false" Text="经费：">
                                        </x:Label>
                                        <x:TextBox ID="txtAgreeExpenditure" Label="批复经费" MaxLength="50" MaxLengthMessage="最多输入20个字符" ShowLabel="true"
                                ...
                                <x:Panel ID="Panel11" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                    <Items>
                                        <x:Label ID="Label17" Width="60px" CssStyle="text-align:right" runat="server" CssClass="marginr" ShowLabel="false" Text="平台">
                                        </x:Label>
                                        <x:Label ID="labPlatformPrincipal" Width="80px" runat="server" CssClass="marginr" ShowLabel="false" Text="负责人：">
                                        </x:Label>
                                        <x:TextBox ID="txtPlatformPrincipal" Label="平台负责人" MaxLength="50" MaxLengthMessage="最多输入20个字符" ShowLabel="true"
                                ...
                                <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                    <Items>
                                        <x:Label ID="Label19" Width="60px" CssStyle="text-align:right" runat="server" CssClass="marginr" ShowLabel="false" Text="平台">
                                        </x:Label>
                                        <x:Label ID="labPlatformMember" Width="80px" runat="server" CssClass="marginr" ShowLabel="false" Text="成员：">
                                        </x:Label>
                                        <x:TextArea ID="txtPlatformMember" Label="平台成员" MaxLength="50" MaxLengthMessage="最多输入200个字符" ShowLabel="true"
                                ...
                                <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextArea ID="txtPlatformManagement" Label="平台管理" MaxLength="50" MaxLengthMessage="最多输入200个字符" ShowLabel="true"
                                ...
                                <x:Panel ID="Panel22" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" Label="平台类别" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex="10"
        ...
        <asp:Panel ID="Panelasp" ShowHeader="false" CssClass="formitem" ShowBorder="true"
            Layout="Column" runat="server" BackColor="White" Height="30px">
            <asp:Label ID="Label" Width="60px" runat="server" CssClass="marginr" ShowLabel="false" Text="">
            </asp:Label>
            <asp:Label ID="labfile" Width="101px" runat="server" CssClass="marginr" ShowLabel="false" Text="相关文档：">
            </asp:Label>
            <input type="file" id="fileupload" style="width: 200px" runat="server" tabindex="12"/>
        </asp:Panel>
