<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_Lectures.aspx.cs" Inherits="WDFramework.UnitLectures.Update_Lectures" %>
...
CssClass="marginr" ShowLabel="false" Text="姓名">
                                        </x:Label>
                                        <x:Label ID="labLecturesName" Width="60px" runat="server" CssClass="marginr" ShowLabel="false" 
Text="：">
                                        </x:Label>
                                ...
                                <x:Panel ID="Panel22" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="txtlistenerNumber" ShowLabel="true" Label="听众人数" MaxLength="5"
                                           Regex="^[1-9]\d*$" Width="200px" CssClass="marginr" runat="server" 
TabIndex="4">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="txtTel" MaxLength="40" ShowLabel="true" Label="手机号" Regex="^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$"
                                ...
                                <x:Panel ID="Panel7" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList ID="DropDownList_SecrecyLevel" Label="保密级别" Width="195px" ShowLabel="true"
                                            AutoPostBack="false" runat="server" Required="true" RequiredMessage="保密级别不能为空" 
TabIndex="12">
                                        </x:DropDownList>
                                    </Items>
                                </x:Panel>
        ...
        <asp:Panel ID="Panelasp" ShowHeader="false" CssClass="formitem" ShowBorder="false"
            ...
            <asp:Label ID="Label21" Width="85px" runat="server" CssClass="marginr" ShowLabel="false" Text="文件路径：">
            </asp:Label>
