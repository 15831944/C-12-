<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_Inspect.aspx.cs" Inherits="WDFramework.UnitInspect.Update_Inspect" %>
...
<body>
    ...
    <x:PageManager ID="PageManager1" AutoSizePanelID="Panel2" runat="server" />
               ...
               <x:Panel ID="Panel2" runat="server" Height="290px" Width="734px" ShowBorder="false"  EnableCollapse="true"
                          ...
                          <x:Panel ID="Panel22" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                              Layout="Column" runat="server">
                                        <Items>
                                           ...
                                           <x:DropDownList Label="参观部门"  AutoPostBack="false" TabIndex="5" Required="true" EnableSimulateTree="true"
                        ...
                        <Items>   
                            ...
                            <x:Panel ID="Panel21" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                              Layout="Column" runat="server">
                                        ...
                                        <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多可输入200个字符" ShowLabel="true" Label="参观内容" CssStyle ="overflow-y:scroll" Required="true" ID="tVisitContent" Width="200px" Height="230px" AutoGrowHeight="false"  AutoGrowHeightMax="230px"  TabIndex="7">
                                        </x:TextArea>                        
                ...
                Layout="Column" runat="server" Height="90px" BackColor="White">
            ...
            <input type="file"  id="fileupload" style="width:200px" runat="server"/>        
                    ...
                    <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false" Layout="Column" runat="server">
                        ...
                        <x:Toolbar ID="Toolbar1" runat="server" ColumnWidth="100%" >
                            ...
                            <x:Button ID="Save"  runat="server" CssClass="marginr" Type="Submit" Text="保存" Icon="Add" OnClick="Save_Click" ValidateForms="Panel2" ConfirmText="确定保存？">
                            </x:Button>                        
