<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateNAReporting.aspx.cs" Inherits="WDFramework.NewAcademicReporting.UpdateNAReporting" %>
                                ...
                                <Items>
                                    <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false" Layout="Column" runat="server">
                                        <Items>
                                            ...
                                            <x:TextBox ID="txtReportName" MaxLength="100" ShowLabel="true" Label="学术报告名称" Required="true"
