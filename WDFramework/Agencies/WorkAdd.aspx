<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkAdd.aspx.cs" Inherits="WDFramework.WorkAdd" %>
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="ParentID2" ShowLabel="true" Label="上级机构" Required="false" Width="200px" runat="server" TabIndex="2" MaxLength="30" AutoPostBack="true" OnTextChanged="ParentID2_TextChanged" Regex="^[\u4E00-\u9FA5A-Za-z]+$">
                                        </x:TextBox>
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel17" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="Area2" ShowLabel="true" Label="面积" Required="true" Width="200px" runat="server" TabIndex="10" MaxLength="20">
                                        </x:TextBox>
                                        <x:Label ID="area3" runat="server" Width="60" ShowLabel="false" Text="平方米"></x:Label>
                    ...
                    <Items>
                        <x:Toolbar ID="Toolbar1" runat="server" ColumnWidth="100%">
                            <Items>
                                ...
                                <x:Button ID="Add" Text="保存" Type="Submit" ConfirmText="确定保存？" Icon="Add" Size="Medium" runat="server" OnClick="Save_Click" ValidateForms="Panel2" ValidateTarget="Top">
                                </x:Button>
                                <x:Button ID="Delete" Text="重置" Icon="Delete" Size="Medium" runat="server" ConfirmText="确定重置？" OnClick="Delete_Click">
                                </x:Button>
                            </Items>
                        </x:Toolbar>
                    </Items>
