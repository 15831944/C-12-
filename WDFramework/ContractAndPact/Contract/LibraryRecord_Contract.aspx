<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LibraryRecord_Contract.aspx.cs" Inherits="WebApplication1.ContractAndPact.Contract.Update_Contract" %>
...
<body oncontextmenu='return false'>
   ...
   <x:Panel ID="Panel1" runat="server"  ShowBorder="True"  EnableCollapse="true"
            ...
            <Items>
                <x:Grid ID="Grid_LibraryRecord_Contract" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    AllowPaging="true" IsDatabasePaging="true" OnPageIndexChange="Grid_LibraryRecord_Contract_PageIndexChange" OnRowCommand="Grid_LibraryRecord_Contract_RowCommand">
                    <Toolbars>
                        <x:Toolbar ID="Toolbar_top" runat="server">
                            <Items>
                                ...
                                <%--这是空行--%>
                                <x:Label ID="labContract" Width="60px" runat="server" CssClass="marginr" ShowLabel="true" Text="资料题目"></x:Label>
                                <x:DropDownList ID="DropDownListContract" ShowLabel="false" AutoPostBack="true" runat="server" EnableEdit="true" >
                                ...
                                <x:Button ID="btnDelete" runat="server" Icon="Delete" Text="删除" Hidden="true" OnClick="btnDelete_Click" ConfirmText="确定删除？" ConfirmTarget="Top" Enabled="false">
                                 ...
                                 <%--<x:Button ID="reprotLibrery" Text="借阅统计"  Icon="Report" EnablePostBack="true" runat="server">
                                    </x:Button>
                                 <x:Button ID="reprot" Text="增减统计"  Icon="Report" EnablePostBack="true" runat="server">
                                    </x:Button>--%>
                            </Items>
                        </x:Toolbar>
                    </Toolbars>
                    ...
                    <ItemTemplate>
                        ...
                        <x:CheckBoxField ID="BoxSelect_ContractRecord" CommandName="CBSelect" DataField="fileid" runat="server" AutoPostBack="true" Enabled="true" RenderAsStaticField="false" Width="30" />
                        ...
                        <x:TemplateField Width="200px" HeaderText="资料名称">
                            <ItemTemplate>
                                <asp:Label ID="labContractName" runat="server" Text='<%# FindByContractIDAndSort(Convert.ToInt32(DataBinder.Eval(Container.DataItem, "LibraryRecordID")),"资料") %>'></asp:Label>
                            </ItemTemplate>
                        </x:TemplateField>
        ...
        <x:Window ID="Window_addFile" Popup="false" EnableIFrame="true"  runat="server"
            EnableMaximize="false" EnableResize="false" Width="400px" Title="添加" Height="350px" >
        </x:Window>
        <x:Window ID="Window_Update" Popup="false" EnableIFrame="true"  runat="server" EnableMinimize="false"
            EnableMaximize="false" EnableResize="false" Width="400px" Title="添加" Height="395px" >
        </x:Window>
