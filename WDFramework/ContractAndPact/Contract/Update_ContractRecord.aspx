<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_ContractRecord.aspx.cs" Inherits="WDFramework.ContractAndPact.Contract.Update_ContractRecord" %>
        ...
        <x:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                ...
                <x:Region ID="Region2" ShowBorder="false" ShowHeader="false" Position="Center" Layout="VBox"
                    ...
                    <Items>
                        <x:Panel ID="Panel2" runat="server" Height="320px" Width="450px" ShowBorder="false" EnableCollapse="true"
                                            ...
                                            <Items>
                                                <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                                    ...
                                                    <Items>
                                                        ...
                                                        <x:TextBox ID="txtContractName" Label="资料名" ShowLabel="true" Required="true" Width="200px" CssClass="marginr" runat="server" Readonly="true" MaxLength="100">
                                                        </x:TextBox>
                                                    </Items>
                                                </x:Panel>
                                                ...
                                                <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                                    ...
                                                    <Items>
                                                        ...
                                                        <x:TextBox ID="txtBorrowPeople" Label="借阅人" ShowLabel="true" Required="true" Width="200px" CssClass="marginr" runat="server" MaxLength="10" CompareMessage="输入最大长度为10个字符" Regex="^[\u4E00-\u9FA5A-Za-z]+$" RegexMessage="只能输入英文或中文" RequiredMessage="借阅人不能为空" TabIndex="1"
                                                            AutoPostBack="true">
                                                        </x:TextBox>
                                                    </Items>
                                                </x:Panel>
                                                ...
                                                <x:Panel ID="Panel15" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                                    ...
                                                    <Items>
                                                        ...
                                                        <x:DatePicker runat="server" Width="195px" EnableEdit="false" ShowLabel="true" Required="true" Label="借阅时间" DateFormatString="yyyy-MM-dd"
                                                            ID="DatePicker_BorrowTime" RequiredMessage="借阅时间不能为空" TabIndex="2">
                                                        </x:DatePicker>
                                                    </Items>
                                                </x:Panel>
                                                ...
                                                <x:Panel ID="Panel7" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                                    ...
                                                    <Items>
                                                        ...
                                                        <x:DatePicker runat="server" EnableEdit="false" Width="195px" ShowLabel="true" Label="归还时间" DateFormatString="yyyy-MM-dd"
                                                            ID="DatePicker_ReturnTime" RequiredMessage="归还时间不能为空" TabIndex="3" AutoPostBack="true">
                                                        </x:DatePicker>
                                                    </Items>
                                                </x:Panel>
                                                ...
                                                <x:Panel ID="Panel22" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                                    ...
                                                    <Items>
                                                        ...
                                                        <x:DropDownList ID="DropDownList_SecrecyLevel" Label="保密级别" Width="195px" ShowLabel="true" AutoPostBack="false" runat="server" Required="true" RequiredMessage="保密级别不能为空" TabIndex="4">
                        ...
                        <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false" Layout="Column" runat="server" Height="40px">
                            <Items>
                                <x:Toolbar ID="Toolbar1" runat="server" ColumnWidth="100%">
                                    <Items>
                                        <x:Label ID="Label15" Width="100px" runat="server" ShowLabel="true" Text=" ">
                                        </x:Label>
                                        <x:Button ID="btnSave" runat="server" CssClass="marginr" Text="保存" Size="Medium" Icon="Add" ConfirmText="确定保存？" ConfirmTarget="Top" ValidateForms="Panel2" OnClick="btnSave_Click" Type="Submit">
                                        </x:Button>
                        ...
                        <%--  <x:Panel ID="Panel8" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            Layout="Column" runat="server">
                            <Items>
                                <x:Button ID="btnSave" runat="server" CssClass="marginr" Text="保存" ConfirmText="确定保存？" ConfirmTarget="Top" ValidateForms="Panel2" OnClick="btnSave_Click">
                                </x:Button>
                                <x:Button ID="btnSet" runat="server" CssClass="marginr"  Text="重置" ConfirmText="确定重置？" EnablePostBack="true" OnClick="btnSet_Click">
                                </x:Button>
