<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Pact.aspx.cs" Inherits="WDFramework.ContractAndPact.Pact.Update_PactRecord" %>
                                ...
                                <x:Panel ID="Panel25" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList ID="DropDownList_SecrecyLevel" Label="保密级别" Width="195px"
                                            ShowLabel="true" AutoPostBack="true" runat="server" Required="true" TabIndex="12">
                                        </x:DropDownList>
