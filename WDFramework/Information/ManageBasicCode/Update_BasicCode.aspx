<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_BasicCode.aspx.cs" Inherits="WDFramework.People.ManageBasicCode.Update_BasicCode" %>
                          ...
                          <x:Label ID="Label2" runat="server" Label="Label" Text=" " Height="30px">
                            ...
                            <x:Panel ID="Panel45" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="CategoryName" Readonly ="true"   ShowLabel="true" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex ="2">
                                        </x:TextBox>
                            ...
                            <x:Panel ID="Panel6" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:Label ID="Label7" Width="80px" CssStyle="text-align:legt" runat="server" CssClass="marginr" ShowLabel="false" Text="类内容：">
                                     ...
                                     <x:TextBox ID="CategoryContent" MaxLength="100"  MaxLengthMessage ="最多输入100个字符"  ShowLabel="true" Label="称号名称" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex ="2">
                                        </x:TextBox> 
                                </Items>
                            </x:Panel>          
                       </Items>               
