<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_File.aspx.cs" Inherits="WDFramework.File.Update_File" %>
            ...
            <x:Panel ID="Panel2" runat="server" Height="310px" ShowBorder="false" EnableCollapse="true"
                        ...
                        <Items>
                            ...
                            <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="文件名" ID="FileName" Required="true" Width="255px" EmptyText="请输入文件名" TabIndex="1" MaxLength="100" MaxLengthMessage="最多可输入100个字符" AutoPostBack="true" OnTextChanged="FileName_TextChanged">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DropDownList Label="保密等级" Required="true" EnableSimulateTree="true" runat="server" ID="DropDownListLevel" Width="250px">
                                    </x:DropDownList>
                                </Items>
                            </x:Panel>
             ...
             <asp:Panel ID="Panelasp" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                Layout="Column" runat="server" Height="25px" BackColor="White">
                  <asp:Label ID="Labell" runat="server" Label="Label" CssClass="marginr" Text=" " Width="15px">
            </asp:Label>  
            <asp:Label ID="Labelll" runat="server" Label="Label" CssClass="marginr" Text="相关文档： " Width="95px">
            </asp:Label>                       
