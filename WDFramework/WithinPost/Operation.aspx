<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Operation.aspx.cs" Inherits="WDFramework.WithinPost.Operation" %>
    ...
    <form id="form1" runat="server">
        ...
        <x:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
            ...
            <Rows>
                ...
                <x:FormRow>
                    <Items>
                       <x:Label ID="agency" Width="100px" Label="文件收放部门"  runat="server" />
                    </Items>
                </x:FormRow>
              <%--  <x:FormRow>
                    <Items>
                       <x:Label ID="recipient" Width="100px" Label="收放接收人"  runat="server" />
                    </Items>
                </x:FormRow>--%>
                <x:FormRow>
                    <Items>
