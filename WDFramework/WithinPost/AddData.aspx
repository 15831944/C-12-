<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddData.aspx.cs" Inherits="WDFramework.WithinPost.AddData" %>
                        ...
                        <Items>
                            ...
                            <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox runat="server" Label="文件名" ID="FileName" Required="true" Width="250px" EmptyText="请输入文件名" MaxLength="100" TabIndex="1" MaxLengthMessage="最多可输入100个字符" AutoPostBack="true" OnTextChanged="FileName_TextChanged">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
