<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Students.aspx.cs" Inherits="WDFramework.People.Add_Students" %>
                            ...
                            <Items>
                                <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_SName" Label="姓名" ShowLabel="true" Required="true" MaxLength="10" MaxLengthMessage="最多输入10个字符" Width="200px" CssClass="marginr" runat="server" TabIndex="1">
                                        </x:TextBox>
                                ...
                                <x:Panel ID="Panel30" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Sno" ShowLabel="true" Label="学号" Width="200px" Required="true" MaxLength="20" MaxLengthMessage="最多输入20个字符" Regex="^[0-9]+$" RegexMessage="只能输入数字" CssClass="marginr" runat="server" TabIndex="2">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel15" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" EnableSimulateTree="true" ShowLabel="false"
                                            Width="195px" CssClass="marginr" Required="true" runat="server" ID="DropDownListDocumentType" TabIndex="4">
                                        </x:DropDownList>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel6" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Contact" ShowLabel="true" Label="联系方式" Required="true" Width="200px" CssClass="marginr" runat="server" MaxLength="20" MaxLengthMessage="最多输入20个字符" TabIndex="6">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" EnableSimulateTree="true" CssClass="marginr" TabIndex="7"
                                ...
                                <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_UserInfoID" ShowLabel="true" Label="指导教师" Width="200px" Required="true" MaxLength="20" MaxLengthMessage="最多输入20个字符" CssClass="marginr" runat="server" TabIndex="8">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                            ...
                            <Items>
                                <x:Panel ID="Panel7" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Specialty" ShowLabel="true" Label="专业" Required="true" Width="200px" MaxLength="20" MaxLengthMessage="最多输入20个字符" CssClass="marginr" runat="server" TabIndex="9">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel25" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_SResearch" ShowLabel="true" Label="研究方向" Required="true" Width="200px" MaxLength="20" MaxLengthMessage="最多输入20个字符" CssClass="marginr" runat="server" TabIndex="10">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel1" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" EnableSimulateTree="true" CssClass="marginr" TabIndex="11"
                                ...
                                <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker runat="server" Label="入学时间" EmptyText="请选择入学时间" Width="195px" CssClass="marginr" TabIndex="12"
                                            ID="DatePickerEnterTime" Required="true" EnableEdit="false">
                                        </x:DatePicker>
                                ...
                                <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:RadioButton ID="IsGraduation" ShowLabel="true" Checked="true" GroupName="IsGraduation" ShowEmptyLabel="true" Text="是" runat="server" TabIndex="13">
                                        </x:RadioButton>
                                ...
                                <x:Panel ID="Panel31" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker runat="server" Label="毕业时间" EmptyText="请选择毕业时间" Width="195px" CssClass="marginr" TabIndex="14"
                                ...
                                <x:Panel ID="Panel8" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_SGraduationDirection" ShowLabel="true" Label="毕业去向单位" Required="true" Width="200px" MaxLength="20" MaxLengthMessage="最多输入20个字符" CssClass="marginr" runat="server" TabIndex="15">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel27" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList Label="保密等级" AutoPostBack="false" Required="true" EnableSimulateTree="true" TabIndex="16"
