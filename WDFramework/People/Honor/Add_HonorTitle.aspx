<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_HonorTitle.aspx.cs" Inherits="WDFramework.People.Honor.Add_HonorTitle" %>
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="TitleName" MaxLength="100" MaxLengthMessage="最多输入100个字符" ShowLabel="true" Label="称号名称" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="2">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
