<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_StaffInfos.aspx.cs" Inherits="WDFramework.People.Update_StaffInfos" %>
                             ...
                             <%--   <x:Panel ID="Panel29" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <x:Panel ID="Panel34" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_LoginName" ShowLabel="true" Label="登录名（校园一卡通号）" MaxLength ="20" MaxLengthMessage ="最多输入20个字符" Width="200px" CssClass="marginr" runat="server" TabIndex ="3">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:RadioButton ID="rbtnBoy" Label="性别" GroupName="sex" Text="男" Checked ="true"  runat="server" TabIndex ="4">
                                        </x:RadioButton>
                                ...
                                <x:Panel ID="Panel30" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        <x:Label ID="Nation" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="民族：">
                                         ...
                                         <x:DropDownList AutoPostBack="false" Label="民族" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex="5"
                                ...
                                <x:Panel ID="Panel7" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Hometown" ShowLabel="true" Label="籍贯" MaxLength ="20" MaxLengthMessage ="最多输入20个字符"   Width="200px" CssClass="marginr" runat="server" TabIndex ="6">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel36" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Domicile" ShowLabel="true" Label="户籍地" Width="200px" MaxLength ="20" MaxLengthMessage ="最多输入20个字符" CssClass="marginr" runat="server" TabIndex ="7">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel8" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_HomeAddress" ShowLabel="true" Width ="200px" Label="家庭住址" MaxLength ="50" MaxLengthMessage ="最多输入50个字符"  CssClass="marginr" runat="server" TabIndex ="8">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker runat="server" Label="出生年月" EmptyText="请选择出生日期" Width="195px" CssClass="marginr" TabIndex ="9"
                                ...
                                <x:Panel ID="Panel25" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:RadioButton ID="ISMarriage" Label="性别"  GroupName="ISMarriage" Text="已婚"  runat="server" TabIndex ="10">
                                        </x:RadioButton>
                                ...
                                <x:Panel ID="Panel23" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Telenum" ShowLabel="true" Label="手机号码" Regex="^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$" RegexMessage ="只能输入手机号码格式" MaxLength ="15" Width="200px" CssClass="marginr" runat="server" TabIndex ="11">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel24" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_HomeTetlum" ShowLabel="true" Label="家庭号码" Regex="\d{3}-\d{8}|\d{4}-\d{7}" RegexMessage ="只能输人家庭号码格式" Width="200px" CssClass="marginr" runat="server" MaxLength ="15" TabIndex ="12">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Officenum" ShowLabel="true" Label="办公电话" Regex="\d{3}-\d{8}|\d{4}-\d{7}" RegexMessage ="只能输入办公电话格式" MaxLength ="15" Width="200px" CssClass="marginr" runat="server" TabIndex ="13">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel17" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                       ...
                                       <%--  Regex ="/^[+]{0,1}(\d){1,3}[ ]?([-]?((\d)|[ ]){1,12})+$/"--%>
                                        <x:TextBox ID="T_Fax" ShowLabel="true" Label="传真" Width="200px" CssClass="marginr" runat="server"  RegexMessage ="只能输入传真格式" MaxLength ="15" MaxLengthMessage ="最多输入15个字符"  TabIndex ="14">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel26" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_QQnum" ShowLabel="true" Label="QQ号码" Regex="[1-9][0-9]{4,}" RegexMessage ="只能输入正确的QQ号码格式" Width="200px" MaxLength ="15" CssClass="marginr" runat="server" TabIndex ="15">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Email" ShowLabel="true" Label="电子信箱" RegexPattern="EMAIL" RegexMessage ="只能输入邮箱格式" Width="200px" MaxLength ="30" CssClass="marginr" runat="server" TabIndex ="16">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel18" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_PostalCode" ShowLabel="true" Label="邮政编码" RegexPattern="POSTAL_CODE" RegexMessage ="只能输入正确的邮政编码" MaxLength ="10" Width="200px" CssClass="marginr" runat="server" TabIndex ="17">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel20" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" EnableSimulateTree="true" ShowLabel="true" Label ="证件类型" TabIndex ="18"
                                ...
                                <x:Panel ID="Panel19" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_DocumentsNum" ShowLabel="true" Label="证件号码"  MaxLength ="20"   Width="200px" CssClass="marginr" runat="server" TabIndex ="19">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel455" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker runat="server" Label="入校时间" EmptyText="请选择入校时间" Width="195px" CssClass="marginr" TabIndex ="20"
                                ...
                                <x:Panel ID="Panel33" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="LastSchool" ShowLabel="true" Label="最后毕业学校"  RegexMessage ="只能输入正确的格式" MaxLength ="30"  Width="200px" CssClass="marginr" runat="server" TabIndex ="21">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel38" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Label="学缘" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex ="22"
                                ...
                                <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Label="学历" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex ="23"
                                ...
                                <x:Panel ID="Panel11" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                       ...
                                       <%-- <x:TextBox ID="T_Degree" ShowLabel="true" Label="学位" Width="150px" MaxLength ="10" MaxLengthMessage ="最多输入10个字符" Required ="true"  CssClass="marginr" runat="server" TabIndex ="17">
                                        ...
                                        <x:DropDownList AutoPostBack="false" Label="学位" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex ="24"
                    ...
                    <x:ListItem Text="博士" Value="2" />
                                ...
                                <x:Panel ID="Panel15" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Reserch" ShowLabel="true" Label="研究方向" Width="200px" MaxLength ="100" MaxLengthMessage ="最多输入100个字符" CssClass="marginr" runat="server" TabIndex ="25">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel16" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_Specilty" ShowLabel="true" Label="专长" Width="200px" MaxLength ="100" MaxLengthMessage ="最多输入100个字符" CssClass="marginr" runat="server" TabIndex ="26">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                            ...
                            <Items>
                                 ...
                                 <x:Panel ID="Panel37" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Label="行政级别" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex ="27"
                                ...
                                <x:Panel ID="Panel40" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" EnableSimulateTree="true" CssClass="marginr" TabIndex ="28"
                                ...
                                <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Label="政治面貌" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex ="29"
                                ...
                                <x:Panel ID="Panel31" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker runat="server" Label="获得时间" EmptyText="请选择获取时间" Width="195px" CssClass="marginr" TabIndex ="30"
                                ...
                                <x:Panel ID="Panel28" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_UnitName" ShowLabel="true" Label="单位名称" Width="200px" MaxLength ="40" MaxLengthMessage ="最多输入40个字符" CssClass="marginr" runat="server" TabIndex ="31">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                 <x:Label ID="Label36" runat="server" Label="Label" Text=" " Height="30px">
                                </x:Label>
                                <%--这是空行--%>
                                  <x:Panel ID="Panel35" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Label="员工类型" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex ="31"
                                ...
                                <x:Panel ID="Panel21" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false"   Label="项目所属机构" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex ="32"
                                ...
                                <x:Panel ID="Panel22" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="T_JobTitle" ShowLabel="true" Label="职称"  MaxLength ="20" MaxLengthMessage ="最多输入20个字符" Width="200px" CssClass="marginr" runat="server" TabIndex ="33">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel39" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker runat="server" Label="获得时间" EmptyText="请选择获取时间" Width="195px" CssClass="marginr" TabIndex ="34"
                                ...
                                <x:Panel ID="Panel41" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                     ...
                                     <Items>
                                        ...
                                        <x:RadioButton ID="IsMasterTeacher"  GroupName="IsMasterTeacher" Text="是" runat="server" TabIndex ="35">
                                        </x:RadioButton>
                                ...
                                <x:Panel ID="Panel43" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:RadioButton ID="IsDoctorTeacher"  GroupName="IsDoctorTeache" Text="是" runat="server" TabIndex ="37">
                                        </x:RadioButton>
                                ...
                                <x:Panel ID="Panel27" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList Label="保密等级" AutoPostBack="false" EnableSimulateTree="true" TabIndex ="39"
                                ...
                                <x:Panel ID="Panel44" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextArea runat="server" MaxLength="2000" MaxLengthMessage ="最多输入2000个字符" ShowLabel="true" Label ="个人简介" CssStyle ="overflow-y:scroll" ID="TextAreaProfile" Width="195px" Height="400px" TabIndex="40">
                                        </x:TextArea>
                                    </Items>
                                </x:Panel>
