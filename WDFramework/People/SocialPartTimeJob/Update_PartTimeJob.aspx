<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_PartTimeJob.aspx.cs" Inherits="WDFramework.People.SocialPartTimeJob.Update_PartTimeJob" %>
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="PartTimeName" MaxLength="20" MaxLengthMessage="最多输入20个字符" ShowLabel="true" Label="兼职职位名称" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="3">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel17" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="AwardDepartments" MaxLength="40" MaxLengthMessage="最多输入40个字符" ShowLabel="true" Label="授予部门" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="4">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel21" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker runat="server" Label="批准时间" EmptyText="请选择日期" EnableEdit="false" Width="195px" CssClass="marginr" Required="true" TabIndex="5"
                                ...
                                <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="Terms" ShowLabel="true" Label="任期" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="6">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList Label="级别" AutoPostBack="false" Required="true" EnableSimulateTree="true" TabIndex="7"
                                ...
                                <x:Panel ID="Panel6" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多输入200个字符" ShowLabel="true"  Label ="备注" ID="Remark" Width="200px" Height="80px" TabIndex="9" CssStyle ="overflow-y:scroll">
                                        </x:TextArea>
                                    </Items>
                                </x:Panel>
