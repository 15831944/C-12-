<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EduExperiences.aspx.cs" Inherits="WDFramework.People.EduExperiences.EduExperiences" %>
...
<body oncontextmenu='return false' ><%--取消鼠标右键的点击--%>
    <form id="form1" runat="server">
       ...
       <x:Panel ID="Panel1" runat="server" BodyPadding="5px" EnableBackgroundColor="true" 
        ...
        <Items>
         <x:Grid ID="GridEduExperience" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
         EnableCheckBoxSelect="false" EnableRowNumber="false" EnableRowNumberPaging="true" EnableTextSelection="true"
         DataKeyNames="EduExperienceID" AllowSorting="true" SortColumnIndex="0"
         SortDirection="DESC" AllowPaging="true" IsDatabasePaging="true" OnRowCommand ="GridEduExperience_RowCommand" OnPageIndexChange ="GridEduExperience_PageIndexChange" >
        <Toolbars>
        <x:Toolbar ID="Toolbar1" runat="server"  Width="1300px" >
            <Items>
                ...
                <x:Button ID="Find" Text="搜索" Icon="SystemSearch" OnClick ="Find_Click" runat="server" Type ="Submit"  >
                 ...
                 <x:Button ID="btnAdd" Text="新增人员教育经历信息" Icon="Add"  runat="server">
                </x:Button>
       ...
       <Columns>   
           ...
           <x:BoundField DataField="EHoldOffice" HeaderText="教育单位" /> 
       <x:BoundField DataField="Major" HeaderText="所学专业" />  
       ...
       <x:BoundField DataField="EndTime" DataFormatString="{0:yyyy-MM-dd}" HeaderText="结束时间" />          
            ...
            <x:BoundField DataField="Remark" HeaderText="备注" Hidden ="true"  />              
              ...
              <x:TemplateField HeaderText="备注" Width="60px" >
                           <ItemTemplate>
                        <a href="javascript:<%# GetEditUrl(Eval("EduExperienceID ")) %>">详情</a>
                          </ItemTemplate>
                          </x:TemplateField>   
       </Columns>
       </x:Grid>
         ...
         <x:Window ID="WindowAdd" Popup="false" EnableIFrame="true" runat="server"
            EnableMaximize="false" EnableResize="false" Height="400px" Width="450px" Title="新增人员教育经历信息">
        </x:Window>
         <x:Window ID="WindowUpdate" Popup="false" EnableIFrame="true" runat="server"
            EnableMaximize="false" EnableResize="false" Height="400px" Width="450px" Title="编辑人员教育经历信息">
        </x:Window>
