<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_EduExperience.aspx.cs" Inherits="WDFramework.People.EduExperiences.Update_EduExperience" %>
            ...
            <Items>
                ...
                <x:Panel ID="Panel2" runat="server" ShowBorder="True" EnableCollapse="true" AutoScroll="true"
                    ...
                    <Items>
                        ...
                        <x:Panel ID="Panel3" Title="教育经历信息" BoxFlex="1" runat="server" ColumnWidth="100%" 
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel17" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                    <Items>
                                        <x:Label ID="ImpactFactor" Width="110px" runat="server" CssClass="marginr" ShowLabel="false" Text="教育单位：">
                                        </x:Label>
                                        <x:TextBox ID="EHoldOffice" MaxLength="20" MaxLengthMessage="最多输入20个字符" ShowLabel="true" Label="教育单位" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="2">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel7" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                    <Items>
                                        <x:Label ID="Label8" Width="110px" runat="server" CssClass="marginr" ShowLabel="false" Text="所学专业：">
                                        </x:Label>
                                        <x:TextBox ID="Major" ShowLabel="true" MaxLength="20" MaxLengthMessage="最多输入20个字符" Label="所学专业" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="3">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                    <Items>
                                        <x:Label ID="Label3" Width="110px" runat="server" CssClass="marginr" ShowLabel="false" Text="开始时间：">
                                        </x:Label>

                                        <x:DatePicker runat="server" Label="开始时间" EmptyText="请选择开始时间" Required="true" EnableEdit="false" Width="195px" CssClass="marginr" TabIndex="4"
                                ...
                                <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                    <Items>
                                        <x:Label ID="PublicJournalName" Width="110px" runat="server" CssClass="marginr" ShowLabel="false" Text="结束时间：">
                                        </x:Label>
                                        <x:DatePicker runat="server" Label="结束时间" EmptyText="请选择结束时间" EnableEdit="false" Required="true" Width="195px" CssClass="marginr" TabIndex="5"
