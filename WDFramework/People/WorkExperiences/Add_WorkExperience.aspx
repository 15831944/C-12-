<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_WorkExperience.aspx.cs" Inherits="WDFramework.People.WorkExperiences.Add_WorkExperience" %>
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="WorkUnit" MaxLength="40" MaxLengthMessage="最多输入40个字符" Label ="工作单位" ShowLabel="true" Width="200px" Required="true" CssClass="marginr" runat="server" TabIndex="2">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
