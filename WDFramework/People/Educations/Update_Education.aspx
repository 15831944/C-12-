<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_Education.aspx.cs" Inherits="WDFramework.People.Educations.Update_Education" %>
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Label="学位" Required ="true" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr" TabIndex="2"
