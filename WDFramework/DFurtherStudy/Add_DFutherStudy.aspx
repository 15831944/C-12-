<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_DFutherStudy.aspx.cs" Inherits="WebApplication1.Add_DFutherStudy" %>
                      ...
                      <x:Label ID="Label2" runat="server" Label="Label" Text=" " Height ="20px" >
                             ...
                             <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                              Layout="Column" runat="server">
                                        ...
                                        <x:TextBox ID="tStudySchool"  MaxLength="30" ShowLabel="true" Label="进修学校" Required="true" Width="200px"   CssClass="marginr" runat="server" TabIndex="3" MaxLengthMessage="最多可输入30个字符" AutoPostBack="true" >
                                        </x:TextBox>
                                        </Items>                
                            </x:Panel>
                             ...
                             <x:Panel ID="Panel6" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                              Layout="Column" runat="server">
                                        ...
                                        <x:DatePicker ID="tDBegainTime" runat="server" Width="200px" Label="进修开始时间" TabIndex="4" Required="true" EnableEdit="false" >
                                        </x:DatePicker>
                           ...
                           <x:Label ID="Label18" runat="server" Label="Label" Text=" " Height ="20px" >
                            ...
                            <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false" 
                              Layout="Column" runat="server">
                                        ...
                                        <x:TextArea runat="server" MaxLength="20" Label="进修内容" ID="tContent"  Required="true" Width="200px" TabIndex="7" Height="100px" CssStyle ="overflow-y:scroll" AutoGrowHeight="false"  AutoGrowHeightMax="100" 
