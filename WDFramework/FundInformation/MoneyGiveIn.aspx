<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyGiveIn.aspx.cs" Inherits="WDFramework.MoneyGiveIn" %>
                        ...
                        <x:Panel ID="Panel9" Title="项目概要" runat="server" ColumnWidth="100%" ShowBorder="false" BodyPadding="40px"
                            ...
                            <Items>
                                <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        <x:Label ID="Label11" Width="110px" runat="server" ShowLabel="false" Text="批准人：">
                                        </x:Label>
                                        <x:TextBox ID="tb_UserInfo" ShowLabel="true" Label="批准人" MaxLength="10" Width="200px" runat="server" Required="true" TabIndex="1">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel16" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:Label ID="Label4" Width="110px" runat="server" ShowLabel="false" Text="所属项目：">
                                        </x:Label>
                                        <x:TextBox ID="tb_SourceWork" ShowLabel="true" AutoPostBack="true" Label="所属项目" MaxLength="30" Width="200px" runat="server" Required="true" TabIndex="2" OnTextChanged="tb_SourceWork_TextChanged">
                                        </x:TextBox>
                                ...
                                <x:Panel ID="Panel19" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:Label ID="Label8" Width="110px" runat="server" CssClass="marginr" ShowLabel="false" ShowRedStar="true" Text="保密等级：">
                                        </x:Label>
                                        <x:DropDownList AutoPostBack="true" Required="true" EnableSimulateTree="true"
                                            ShowRedStar="true" runat="server" ID="DropDownListLevel" Width="195px" EnableEdit="false" Label="保密等级" TabIndex="3">
                                        </x:DropDownList>
                                ...
                                <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:Label ID="Label13" Width="110px" runat="server" ShowLabel="false" Text="金额(元)：">
                                        </x:Label>
                                        <x:TextBox ID="tb_MoneyNum" AutoPostBack="true" ShowLabel="true" Label="金额" Width="200px" runat="server" Required="true" TabIndex="4" OnTextChanged="tb_MoneyNum_TextChanged">
                                        </x:TextBox>
                                ...
                                <x:Panel ID="Panel15" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:Label ID="Label14" Width="110px" runat="server" ShowLabel="false" Text="支出时间：">
                                        </x:Label>
                                        <x:DatePicker ID="dp_Time" runat="server" ShowLabel="true" Label="支出时间" Width="195px" Required="true" TabIndex="5">
                                        </x:DatePicker>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel17" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:Label ID="Label16" Width="110px" runat="server" ShowLabel="false" Text="用途：">
                                        </x:Label>
                                        <x:DropDownList ID="ddl_FundingPurposeSortID" ShowLabel="true" Label="用途" AutoPostBack="true" runat="server" Width="195px" EnableEdit="false" ForceSelection="false" Required="true" TabIndex="6">
                                        </x:DropDownList>
