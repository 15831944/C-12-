<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Paper.aspx.cs" Inherits="WebApplication1.Add_Paper" %>
...
<%--        <x:Panel ID="Panel1" runat="server" BodyPadding="5px" EnableBackgroundColor="true"
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="tSubject" MaxLength="100" MaxLengthMessage="最多可輸入100个字符" ShowLabel="true" Label="论文题目" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="1" AutoPostBack="true" OnTextChanged="tSubject_TextChanged">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="tPublicJournalName" MaxLength="20" MaxLengthMessage="最多可输入20个字符" ShowLabel="true" Label="发表刊物" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="2">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker ID="dPublicDate" runat="server" Width="200px" Required="true" EnableEdit="false" ShowLabel="true" TabIndex="3" Label="发表时间" AutoPostBack="true">
                                        </x:DatePicker>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel11" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="tQuoteNum" RegexPattern="NUMBER" RegexMessage="只能输入数字" ShowLabel="true" Label="引用次数" Width="200px" Required="true" CssClass="marginr" runat="server" TabIndex="7">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="tHQuoteNum" RegexPattern="NUMBER" RegexMessage="只能输入数字" ShowLabel="true" Label="他引次数" Width="200px" Required="true" CssClass="marginr" runat="server" TabIndex="8" AutoPostBack="true" OnTextChanged="tHQuoteNum_TextChanged">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="tStartPageNum" RegexPattern="NUMBER" RegexMessage="只能输入数字" ShowLabel="true" Label="起始页码" Width="200px" Required="true" CssClass="marginr" runat="server" TabIndex="9">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel21" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="tEndPageNum" RegexPattern="NUMBER" RegexMessage="只能输入数字" ShowLabel="true" Label="结束页码" Width="200px" Required="true" CssClass="marginr" runat="server" TabIndex="10" AutoPostBack="true" OnTextChanged="tEndPageNum_TextChanged">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList ID="dRetrieveSituation" ShowLabel="true" Label="检索情况" Required="true" Width="195px" AutoPostBack="true" runat="server" TabIndex="11">
                                        </x:DropDownList>
                                ...
                                <x:Panel ID="Panel29" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList Label="刊物级别" AutoPostBack="false" Required="true" EnableSimulateTree="true" TabIndex="12"
                                ...
                                <x:Panel ID="Panel15" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多可输入200个字符" ShowLabel="true" EmptyText="两个或两个以上请用逗号隔开" CssStyle="overflow-y:scroll" Label="收录号" ID="tIncludeNum" Required="true" Width="200px" Height="105px" AutoGrowHeight="false" AutoGrowHeightMax="105" TabIndex="13">
                                        </x:TextArea>
                                    </Items>
                                </x:Panel>
                            ...
                            <Items>
                                ...
                                <x:Panel ID="Panel17" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="tImpactFactor" MaxLength="5" MaxLengthMessage="最多可输入5个字符" ShowLabel="true" Label="影响因子" Width="200px" Required="true" CssClass="marginr" runat="server" TabIndex="14">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel28" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="tAchievement" ShowLabel="true" Label="所属成果名称" MaxLength="100" MaxLengthMessage="最多可输入100个字符" Width="200px" CssClass="marginr" runat="server" TabIndex="16" AutoPostBack="true" OnTextChanged="tAchievement_TextChanged">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel7" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList ID="dSecrecyLevel" ShowLabel="true" Label="保密级别：" Required="true" EnableEdit="false" Width="195px" Readonly="true" AutoPostBack="true" runat="server" TabIndex="17">
                                ...
                                <x:Panel ID="Panel8" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="FirstWriter" MaxLength="10" MaxLengthMessage="最多可输入10个字符" ShowLabel="true" Label="第一作者" Width="200px" Required="true" CssClass="marginr" runat="server" TabIndex="18">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel24" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="MessageWriter" MaxLength="10" MaxLengthMessage="最多可输入10个字符" ShowLabel="true" Label="通讯作者" Width="200px" Required="true" CssClass="marginr" runat="server" TabIndex="20">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel25" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="MWAgency" MaxLength="50" MaxLengthMessage="最多可输入50个字符" ShowLabel="true" Label="通讯作者部门" Width="200px" Required="true" CssClass="marginr" runat="server" TabIndex="21">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel27" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                    <Items>
                                        <x:Label ID="Label29" Width="110px" runat="server" CssClass="marginr" ShowLabel="false" Text="分类：">
                                        </x:Label>
                                        <x:DropDownList ID="DropDownList_Sort" ShowLabel="true" Label="分类：" Required="true" EnableEdit="false" Width="195px" AutoPostBack="true" runat="server" TabIndex="22">
                                ...
                                <x:Panel ID="Panel18" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    Layout="Column" runat="server">
                                    <Items>
                                        <x:Label ID="Label6" Width="110px" runat="server" CssClass="marginr" ShowLabel="false" Text="全部作者：">
                                        </x:Label>
                                        <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多可输入200个字符" ShowLabel="true" EmptyText="两个或两个以上请用逗号隔开" CssStyle="overflow-y:scroll" Required="true" Label="全部作者" ID="PaperPeople" Width="200px" Height="120px" AutoGrowHeight="false" AutoGrowHeightMax="100" TabIndex="23">
                                        </x:TextArea>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel19" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextArea runat="server" MaxLength="500" MaxLengthMessage="最多可输入500个字符" ShowLabel="true" Label="备注" ID="tRemark" CssStyle="overflow-y:scroll" Width="200px" Height="120px" AutoGrowHeight="false" AutoGrowHeightMax="100" TabIndex="24">
                                        </x:TextArea>
                                    </Items>
                                </x:Panel>
                            </Items>
 ...
 <%--           </Items>
        ...
        <asp:Panel ID="Panelasp" ShowHeader="false" ShowBorder="false"
            ...
            <asp:Label ID="Label30" runat="server" Label="Label" CssClass="marginr" Text=" " Width="100px">
            </asp:Label>
            <asp:Label ID="Label31" runat="server" Label="Label" CssClass="marginr" Text="相关文档： " Width="95px">
            </asp:Label>
