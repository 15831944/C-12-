<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="File.aspx.cs" Inherits="WDFramework.Achievement.Paper.File" %>
    ...
    <form id="form1" runat="server">
        ...
        <x:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
            ...
            <Rows>
                <x:FormRow>
                    <Items>
                        <x:Label ID="title" Width="100px" Label="题目"  runat="server" />
                    </Items>
                </x:FormRow>
                <x:FormRow>
                    <Items>
                       <x:Label ID="firstWriter" Width="100px" Label="第一作者"  runat="server" />
                    </Items>
                </x:FormRow>
                <x:FormRow>
                    <Items>
                       <x:Label ID="writerIdentity" Width="100px" Label="论文作者身份"  runat="server" />
                    </Items>
                </x:FormRow>
                <x:FormRow>
                    <Items>
