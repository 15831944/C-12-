<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Award.aspx.cs" Inherits="WebApplication1.Add_Adward" %>
...
<body oncontextmenu='return false'>
    ...
    <form id="form1" runat="server">
        ...
        <x:Panel ID="Panel2" runat="server" ShowBorder="false" EnableCollapse="true"
            Layout="HBox" BoxConfigAlign="Stretch" BoxConfigPosition="Start" BoxConfigPadding="5" Height="420px"
                    ...
                    <Items>
                        <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="tAwardName" MaxLength="100" MaxLengthMessage="最多可输入100个字符" ShowLabel="true" Label="获奖名称" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="1" OnTextChanged="tAwardName_TextChanged">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                        ...
                        <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:DropDownList ID="dAwardwSpecies" ShowLabel="true" EnableEdit="false" Label="获奖类别" Required="true" Width="195px" AutoPostBack="true" runat="server" TabIndex="2">
                                </x:DropDownList>
                        ...
                        <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:DropDownList ID="dGrade" ShowLabel="true" EnableEdit="false" Label="获奖等级" Required="true" Width="195px" AutoPostBack="true" runat="server" TabIndex="3">
                                </x:DropDownList>
                        ...
                        <x:Panel ID="Panel21" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="tGivenAgency" MaxLength="20" MaxLengthMessage="最多可输入20个字符" ShowLabel="true" Label="授予机构" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="5">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                        ...
                        <x:Panel ID="Panel8" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:DropDownList ID="dSecrecyLevel" ShowLabel="true" EnableEdit="false" Label="保密级别" Required="true" Width="195px" AutoPostBack="true" runat="server" TabIndex="6">
                                </x:DropDownList>
                        ...
                        <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="Unit1" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Label="单位1" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="7">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                        ...
                        <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="Unit2" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Label="单位2" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="8">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                        ...
                        <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="Unit3" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Label="单位3" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="9">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                        ...
                        <x:Panel ID="Panel15" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="Unit4" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Label="单位4" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="10">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                    ...
                    <Items>
                        ...
                        <x:Panel ID="Panel16" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="Unit5" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Required="true" Label="单位5" Width="200px" CssClass="marginr" runat="server" TabIndex="11">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                        ...
                        <x:Panel ID="Panel134" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:DropDownList ID="dAwardForm" ShowLabel="true" EnableEdit="false" Label="获奖类型" Required="true" Width="195px" AutoPostBack="true" runat="server" TabIndex="12">
                                </x:DropDownList>
                                <%--  <x:TextBox ID="tGrade" MaxLength="5" ShowLabel="true" MaxLengthMessage="最多可输入5个字符" Label="获奖等级" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="3">
                                </x:TextBox>--%>
                            </Items>
                        ...
                        <x:Panel ID="Panel154" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="AwardNum" MaxLength="50" MaxLengthMessage="最多可输入50个字符" ShowLabel="true" Required="true" Label="获奖证书号" Width="200px" CssClass="marginr" runat="server" TabIndex="13">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                        ...
                        <x:Panel ID="Panel11" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="FirstAward" MaxLength="10" MaxLengthMessage="最多可输入10个字符" ShowLabel="true" Required="true" Label="第一获奖人" Width="200px" CssClass="marginr" runat="server" TabIndex="14">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                        ...
                        <x:Panel ID="Panel213" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:DropDownList ID="DropDownList_Sort" ShowLabel="true" Label="分类：" Required="true" EnableEdit="false" Width="195px" AutoPostBack="true" runat="server" TabIndex="19">
                        ...
                        <x:Panel ID="Panelk" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextArea runat="server" MaxLength="500" EmptyText="两个或两个以上请用逗号隔开" MaxLengthMessage="最多可输入500个字符" ID="tachievement" CssStyle="overflow-y:scroll" Label="成果名称" AutoPostBack="true" ShowLabel="true" Width="195px" Height="40px" TabIndex="15" OnTextChanged="tachievement_TextChanged">
                                </x:TextArea>
                            </Items>
                        </x:Panel>
                        ...
                        <%--<x:Panel ID="Panel" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextArea runat="server" MaxLength="250" EmptyText="两个或两个以上请用逗号隔开" MaxLengthMessage="最多可输入250个字符" CssStyle="overflow-y:scroll" Required="true" ID="AwardPeople" Label="全部获奖人" ShowLabel="true" Width="195px" Height="40px" AutoGrowHeight="false" TabIndex="16">
                                </x:TextArea>
                            </Items>
                        </x:Panel>
                        ...
                        <%--这是空行--%>
                        <x:Panel ID="Panel06" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            Layout="Column" runat="server">
                             <Items>
                                <x:Label ID="Member" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="成员及排序：">
                                 </x:Label>
                                <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多可输入200个字符" CssStyle="overflow-y:scroll" ID="Members" Label="成员及排序" ShowLabel="true" Width="195px" Height="40px" AutoGrowHeight="false" TabIndex="17">
                                </x:TextArea>
                            </Items>
                        </x:Panel>
                        <%--这是空行--%>
                        <x:Panel ID="Panel_2015" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多可输入200个字符" CssStyle="overflow-y:scroll" ID="tRemark" Label="备注" ShowLabel="true" Width="195px" Height="40px" AutoGrowHeight="false" TabIndex="18">
                                </x:TextArea>
                            </Items>
                        </x:Panel>
