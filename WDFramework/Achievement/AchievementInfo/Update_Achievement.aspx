<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_Achievement.aspx.cs" Inherits="WebApplication1.Achievement.Achievement.Update_Achievement" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <x:Panel ID="Panel2" runat="server" Height="310px" Width="734px" ShowBorder="false" EnableCollapse="true"
                        ...
                        <Items>
                            ...
                            <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="tProjectID" ShowLabel="true" Label="所属项目" MaxLength="60" MaxLengthMessage="最多可输入60个字符" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="3" AutoPostBack="true">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel1" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                Layout="Column" runat="server">
                                <Items>
                                    <x:Label ID="Label2" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="项目内部编号：">
                                    </x:Label>
                            ...
                            <x:Panel ID="Panel18" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                Layout="Column" runat="server">
                                <Items>
                                    <x:Label ID="Label22" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="成员：">
                                    </x:Label>
                        ...
                        <Items>
                            ...
                            <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DatePicker ID="dAppraisalTime" runat="server" EnableEdit="false" Width="200px" ShowLabel="true" Label="鉴定时间：" Required="true" TabIndex="11">
                                    </x:DatePicker>
                                </Items>
                            </x:Panel>
            ...
            <asp:Label ID="Label23" runat="server" Label="Label" CssClass="marginr" Text=" " Width="35px">
                </asp:Label>
                <asp:Label ID="Label24" runat="server" Label="Label" CssClass="marginr" Text="鉴定意见页： " Width="95px">
                </asp:Label>
                <input type="file" id="OpinionPage1" style="width: 200px" runat="server" />
            </asp:Panel>
            <asp:Panel ID="Panel19" ShowHeader="false" ShowBorder="false"
                Layout="Column" runat="server" BackColor="White">
                <asp:Label ID="Label25" runat="server" Label="Label" CssClass="marginr" Text=" " Width="35px">
                </asp:Label>
                <asp:Label ID="Label26" runat="server" Label="Label" CssClass="marginr" Text="课题组成员页： " Width="95px">
                </asp:Label>
                <input type="file" id="MemberPage1" style="width: 200px" runat="server" />
                <asp:Label ID="Label27" runat="server" Label="Label" CssClass="marginr" Text=" " Width="35px">
                </asp:Label>
                <asp:Label ID="Label28" runat="server" Label="Label" CssClass="marginr" Text="组织单位盖章页： " Width="95px">
                </asp:Label>
                <input type="file" id="SealPage1" style="width: 200px" runat="server" />
            </asp:Panel>
