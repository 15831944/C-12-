<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_AchievementApply.aspx.cs" Inherits="WDFramework.Acheievement.AchievementApply.Update_AchievementApply" %>
                    ...
                    <Items>
                        ...
                        <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:TextArea ID="TextAreaMember" MaxLength="2000" MaxLengthMessage="最多可输入2000个字符" ShowLabel="true" Label="成员" Required="true" Width="195px" Height="300px" CssClass="marginr" runat="server" TabIndex="8" AutoPostBack="true" OnTextChanged="tAchievement_TextChanged">
                                </x:TextArea>
                            </Items>
                        </x:Panel>
