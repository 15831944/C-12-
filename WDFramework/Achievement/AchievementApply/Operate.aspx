<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Operate.aspx.cs" Inherits="WDFramework.Achievement.AchievementApply.Operate" %>
    ...
    <form id="form1" runat="server">
        ...
        <x:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
            ...
            <Rows>
                ...
                <x:FormRow>
                    <Items>
                       <x:Label ID="unit" Width="100px" Label="应用单位"  runat="server" />
                    </Items>
                </x:FormRow>
                <x:FormRow>
                    <Items>
                       <x:Label ID="use" Width="100px" Label="用途"  runat="server" />
                    </Items>
                </x:FormRow>
                <x:FormRow>
                    <Items>
