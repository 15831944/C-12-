<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_AchievementCA.aspx.cs" Inherits="WebApplication1.Achievement.AchievementCA.Update_AchievementCA" %>
...
<body oncontextmenu='return false'>
    ...
    <form id="form1" runat="server">
        ...
        <x:Panel ID="Panel2" runat="server" ShowBorder="false" EnableCollapse="true" AutoScroll="true"
            Layout="HBox" BoxConfigAlign="Stretch" BoxConfigPosition="Start" BoxConfigPadding="5" Height="300px"
                ...
                <x:Panel ID="Panel3" Title="项目概要" BoxFlex="1" runat="server"
                    ...
                    <Items>
                        ...
                        <x:Panel ID="Panel_2015" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            Layout="Column" runat="server">
                            <Items>
                                <x:Label ID="ProjectMember" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="成员：">
                                </x:Label>
                                <x:TextBox ID="tProjectMember" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Label="成员" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="2">
                                </x:TextBox>
                            </Items>
                        </x:Panel>
                        ...
                        <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:DatePicker ID="dCATime" runat="server" Width="200px" ShowLabel="true" EnableEdit="false" Label="验收时间" Required="true" TabIndex="3">
                                </x:DatePicker>
                            </Items>
                        </x:Panel>
        ...
        <asp:Panel ID="Panelasp" ShowHeader="false" ShowBorder="false"
            Layout="Column" runat="server" Height="75px" BackColor="White">
