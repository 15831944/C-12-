<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Operate.aspx.cs" Inherits="WDFramework.Achievement.AchievementCA.Operate" %>
    ...
    <form id="form1" runat="server">
        ...
        <x:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
            ...
            <Rows>
                <x:FormRow>
                    <Items>
                        <x:Label ID="name" Width="100px" Label="项目名称"  runat="server" />
                    </Items>
                </x:FormRow>
                <x:FormRow>
                    <Items>
                       <x:Label ID="unit" Width="100px" Label="验收部门"  runat="server" />
                    </Items>
                </x:FormRow>
                <x:FormRow>
                    <Items>
                       <x:Label ID="level" Width="150px" Label="验收评语级别"  runat="server" />
                    </Items>
                </x:FormRow>
                <x:FormRow>
                    <Items>
