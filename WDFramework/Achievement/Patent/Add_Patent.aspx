<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Patent.aspx.cs" Inherits="WebApplication1.Add_Patent" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <x:Panel ID="Panel2" runat="server" Height="450px" Width="734px" ShowBorder="false" EnableCollapse="true"
                ...
                <Items>
                    <x:Panel ID="Panel3" Title="项目概要" BoxFlex="1" runat="server"
                        BodyPadding="5px" BoxMargin="0 0 0 30" ShowBorder="false" ShowHeader="false" AutoScroll="true">
                        <Items>
                            <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="tPatentName" MaxLength="100" MaxLengthMessage="最多可输入100个字符" ShowLabel="true" Label="专利名称：" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="1">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel1" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="tPatentNumber" MaxLength="20" MaxLengthMessage="最多可输入20个字符" ShowLabel="true" Label="专利号：" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="3">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel17" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DropDownList ID="dPatentForm" ShowLabel="true" Label="专利类型" Required="true" Width="195px" AutoPostBack="true" runat="server" TabIndex="4">
                                    </x:DropDownList>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DatePicker ID="tApplicationTime" runat="server" ShowLabel="true" EnableEdit="false" Label="申请时间" Required="true" Width="195px" TabIndex="5">
                                    </x:DatePicker>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel16" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DatePicker ID="tAccreditTime" runat="server" ShowLabel="true" EnableEdit="false" Required="true" Label="授权时间" Width="195px" TabIndex="6">
                                    </x:DatePicker>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel11" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="tCertificateNumber" MaxLength="20" MaxLengthMessage="最多可输入20个字符" ShowLabel="true" Label="证书号" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="7">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel21" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="tGivenUnit" MaxLength="20" ShowLabel="true" MaxLengthMessage="最多可输入20个字符" Label="授予机构" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="8">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel18" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="tState" MaxLength="10" MaxLengthMessage="最多可输入10个字符" ShowLabel="true" Label="状态" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="9">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DropDownList Label="所属部门" AutoPostBack="false" Required="true" EnableSimulateTree="true"
                                        runat="server" ID="DropDownListAgency" Width="195px" TabIndex="10">
                                    </x:DropDownList>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel22" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                Layout="Column" runat="server">
                                <Items>
                                    <x:Label ID="Label24" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="专利授权号：">
                                    </x:Label>
                                    <x:TextBox Label="专利授权号" AutoPostBack="false" Required="true"
                                        runat="server" ID="tPatentAuthorization" Width="195px" TabIndex="10">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                        </Items>
                    ...
                    <x:Panel ID="Panel6" Title="项目概要" BoxFlex="1" runat="server"
                        ...
                        <Items>
                            ...
                            <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:DropDownList Label="专利情况" AutoPostBack="false" Required="true" EnableSimulateTree="true"
                            ...
                            <x:Panel ID="Panel22" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="ApplyNum" MaxLength="20" MaxLengthMessage="最多可输入20个字符" ShowLabel="true" Label="申请号" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="12">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            <x:Label ID="Label23" runat="server" Label="Label" Text=" " Height="20px">
                            ...
                            <x:Panel ID="Panel23" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="Fund" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Label="经费" Required="true" Regex="^\d+\.?\d+$|^\d+$" RegexMessage="只能输入数字" Width="200px" CssClass="marginr" runat="server" TabIndex="13">
                                    </x:TextBox>
                            ...
                            <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="tPatentDepartment1" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Label="单位1" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="14">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel8" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="tPatentDepartment2" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Required="true" Label="单位2" Width="200px" CssClass="marginr" runat="server" TabIndex="15">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel15" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="tPatentDepartment3" MaxLength="40" MaxLengthMessage="最多可输入40个字符" ShowLabel="true" Required="true" Label="单位3" Width="200px" CssClass="marginr" runat="server" TabIndex="16">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel755" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                Layout="Column" runat="server">
                                <Items>
                                    ...
                                    <x:DropDownList ID="drSecrecyLevel" ShowLabel="true" Label="保密级别：" Required="true" EnableEdit="false" Width="195px" AutoPostBack="true" runat="server" TabIndex="17">
                                    </x:DropDownList>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel24" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextBox ID="FirstPeople" MaxLength="20" MaxLengthMessage="最多可输入20个字符" ShowLabel="true" Label="第一发明人" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="18">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel20" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多可输入200个字符" ShowLabel="true" Required="true" EmptyText="两个或两个以上请用逗号隔开" CssStyle="overflow-y:scroll" Label="全部发明人" ID="PatentPeople" Width="195px" Height="70px" AutoGrowHeight="false" AutoGrowHeightMax="70" TabIndex="19">
                                    </x:TextArea>
                                </Items>
                            </x:Panel>
                       ...
                       <%-- <x:Panel ID="Panel7" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                Layout="Column" runat="server">
                                <Items>
                                    <x:Label ID="Label31" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="成员：">
                                    </x:Label>
                                    <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多可输入200个字符" ShowLabel="true" Required="true" EmptyText="两个或两个以上请用逗号隔开" CssStyle="overflow-y:scroll" Label="成员" ID="PatentMember" Width="195px" Height="70px" AutoGrowHeight="false" AutoGrowHeightMax="70" TabIndex="19">
                                    </x:TextArea>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel19" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多可输入200个字符" ID="tRemark" Label="备注" ShowLabel="true" Width="195px" Height="70px" CssStyle="overflow-y:scroll" AutoGrowHeight="false" AutoGrowHeightMax="70" TabIndex="20">
                                    </x:TextArea>
                                </Items>
                            </x:Panel>
                            <x:Label ID="Label26" runat="server" Label="Label" Text=" " Height="20px">
                            ...
                            <x:Panel ID="Panel23" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                Layout="Column" runat="server">
                                <Items>
                                    <x:Label ID="Label29" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="专利证书号：">
                                    </x:Label>
                                    <x:TextBox Label="专利证书号" AutoPostBack="false" Required="true"
                                        runat="server" ID="tPatentCertificate" Width="195px" TabIndex="10">
                                    </x:TextBox>
                                </Items>
                            </x:Panel>
                        </Items>
            ...
            <asp:Panel ID="Panel7" ShowHeader="false" ShowBorder="false"
                Layout="Column" runat="server" Height="25px" BackColor="White">
                <asp:Label ID="Label16" runat="server" Label="Label" CssClass="marginr" Text=" " Width="35px">
                </asp:Label>
