<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_AchieveAward.aspx.cs" Inherits="WebApplication1.Add_AchieveAward" %>
                        ...
                        <Items>
                            ...
                            <x:Panel ID="Panel19" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextArea runat="server" MaxLength="300" Required="true" MaxLengthMessage="最多可输入300个字符" ShowLabel="true" EmptyText="两个或两个以上请用逗号隔开" CssStyle ="overflow-y:scroll" Label="报奖人" ID="tAwardPeople" Width="200px" Height="100px" AutoGrowHeight="false"  AutoGrowHeightMax="100" TabIndex="7">
                                    </x:TextArea>
                                </Items>
                            </x:Panel>
                            ...
                            <x:Panel ID="Panel6" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                ...
                                <Items>
                                    ...
                                    <x:TextArea runat="server" MaxLength="200" MaxLengthMessage="最多可输入200个字符" ShowLabel="true" EmptyText="两个或两个以上请用逗号隔开" CssStyle ="overflow-y:scroll" Label="报奖人" ID="tMember" Width="200px" Height="100px" AutoGrowHeight="false"  AutoGrowHeightMax="100" TabIndex="7">
                                    </x:TextArea>
                                </Items>
                            </x:Panel>
                        </Items>
