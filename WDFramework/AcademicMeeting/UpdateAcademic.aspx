<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateAcademic.aspx.cs" Inherits="WDFramework.AcademicMeeting.UpdateAcademic" %>
...
CssClass="marginr" runat="server" >
        ...
        <%--<asp:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                Layout="Column" runat="server" Height="120px" BackColor="White">
                  <asp:Label ID="Label13" runat="server" Label="Label" CssClass="marginr" Text=" " Width="15px">
            </asp:Label>  
            <asp:Label ID="Label14" runat="server" Label="Label" CssClass="marginr" Text="相关文档： " Width="95px">
            </asp:Label>                       
