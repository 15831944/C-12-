<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Year_souse.aspx.cs" Inherits="WDFramework.Report.Year_souse" %>
...
<body>
    ...
    <rsweb:ReportViewer  style="margin:auto auto;" ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" ProcessingMode="Remote" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt"  Width="1026px"  Height ="825px">
        <ServerReport ReportPath="/报表项目2/Year_souse" ReportServerUrl=" http://win-ja7hpm931cq/ReportServer_SA" />
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
