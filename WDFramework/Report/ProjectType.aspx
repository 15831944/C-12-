<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectType.aspx.cs" Inherits="WDFramework.Report.ProjectType" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" style="margin:auto auto;" Width ="1950px" Font-Names="Verdana" Font-Size="8pt" ProcessingMode="Remote" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt"  Height ="825px">
            <ServerReport ReportPath="/报表项目2/ProjectType" ReportServerUrl="http://win-ja7hpm931cq/ReportServer_SA" />
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
