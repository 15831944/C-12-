<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADD_ProjectImportant.aspx.cs" Inherits="WDFramework.Projects.ADD_ProjectImportant" %>
                       ...
                       <Items>
                             <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false" 
                              Layout="Column" runat="server">
                                        ...
                                        <x:Label ID="MissionName2" Width="100px" runat="server"   CssClass="marginr" ShowLabel="false" Text="节点名称：">
                                            ...
                                            <x:TextArea runat="server" Label ="节点名称" MaxLength="500" MaxLengthMessage="最多输入500个字符" Required ="true"  ShowLabel="true"  ID="MissionName" Width="195px" Height="80px" TabIndex="1" CssStyle ="overflow-y:scroll">
                                        </x:TextArea>
                            ...
                            <x:Panel ID="Panel16" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                              Layout="Column" runat="server">
                                        ...
                                        <x:Label ID="Label4" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="开始时间：">
                                            ...
                                            <x:DatePicker runat="server" Required="true" Label="开始时间" EmptyText="请选择时间" EnableEdit ="false"   Width="200px" CssClass="marginr" TabIndex ="2"                    
                             ...
                             <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                              Layout="Column" runat="server">
                                        ...
                                        <x:Label ID="Label5" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="计划完成时间：">
                                            ...
                                            <x:DatePicker runat="server" Required="true" Label="计划完成时间" EmptyText="请选择时间" EnableEdit ="false"   Width="200px" CssClass="marginr" TabIndex ="3"                    
                             ...
                             <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                              Layout="Column" runat="server">
                                        ...
                                        <x:Label ID="ProjectID" Width="100px" runat="server" CssClass="marginr" ShowLabel="false" Text="所属项目：">
                                            ...
                                            <x:DropDownList   AutoPostBack="false" Required="true" Label ="所属项目"  EnableSimulateTree="true" ShowLabel="true" Width="200px" CssClass="marginr" TabIndex ="4"                   
                           ...
                           <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="txtProjectCompletion" MaxLength="20" ShowLabel="true" Label="项目完成情况"  Width="200px" CssClass="marginr" runat="server" TabIndex="5">
