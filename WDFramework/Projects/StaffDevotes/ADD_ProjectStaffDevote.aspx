<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADD_ProjectStaffDevote.aspx.cs" Inherits="WDFramework.Projects.ADD_ProjectStaffDevote" %>
                            ...
                            <Items>
                                <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="UserInfoName" Label="人员名称" ShowLabel="true" Required="true" Width="200px" CssClass="marginr" runat="server">
                                        </x:TextBox>
                                ...
                                <x:Panel ID="Panel16" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker runat="server" Required="true" Label="投入时间" EmptyText="请选择投入时间" EnableEdit="false" Width="195px" CssClass="marginr"
                                ...
                                <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" Label="所属项目" EnableSimulateTree="true" ShowLabel="true" Width="195px" CssClass="marginr"
                                ...
                                <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList Label="保密等级" AutoPostBack="false" Required="true" EnableSimulateTree="true"
                                ...
                                <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList Label="排序" AutoPostBack="false" Required="true" EnableSimulateTree="true"
                                ...
                                <x:Panel ID="Panel5" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="tb_ProjectCompletion" Label="项目承担任务及完成情况" ShowLabel="true" Required="true" Width="200px" CssClass="marginr" runat="server">
                                        </x:TextBox>
