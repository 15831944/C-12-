<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADD_Projects.aspx.cs" Inherits="WDFramework.Projects.ADD_Projects" %>
...
<body oncontextmenu='return false'>
    ...
    <form id="form1" runat="server">
                    ...
                    <Items>
                            ...
                            <Items>
                                <x:Panel ID="Panel12" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="ProjectName2" Label="项目名称" ShowLabel="true" MaxLength="100" MaxLengthMessage="最多输入100个字符" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="1">
                                        </x:TextBox>
                                ...
                                <x:Panel ID="Panel16556" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="ProjectInNum" Label="项目内部编号（科技处）" ShowLabel="true" MaxLength="50" MaxLengthMessage="最多输入50个字符" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="2">
                                        </x:TextBox>
                                ...
                                <x:Panel ID="Panel34" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="PactNum2" ShowLabel="true" Label="合同编号" MaxLength="20" MaxLengthMessage="最多输入20个字符" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="3">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel11" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="TaskNum2" ShowLabel="true" Label="课题编号" MaxLength="20" MaxLengthMessage="最多输入20个字符" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="4">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel8" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="SourceUnit2" ShowLabel="true" Label="项目来源" Required="true" MaxLength="20" MaxLengthMessage="最多输入20个字符" Width="200px" CssClass="marginr" runat="server" TabIndex="5">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel20" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" EnableSimulateTree="true" ShowLabel="false" TabIndex="7"
                                ...
                                <x:Panel ID="Panel7" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" EnableSimulateTree="true" ShowLabel="false" TabIndex="8"
                                ...
                                <x:Panel ID="Panel10" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" EnableSimulateTree="true" ShowLabel="false" TabIndex="9"
                                ...
                                <x:Panel ID="Panel13" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" EnableSimulateTree="true" Label="项目所属机构" ShowLabel="false" TabIndex="10"
                                ...
                                <x:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="ProjectManager" ShowLabel="true" Label="项目负责人(前三人)" Width="200px" Required="true" MaxLength="20" MaxLengthMessage="最多输入20个字符" CssClass="marginr" runat="server" TabIndex="11">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel30" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="ProjectHeads2" ShowLabel="true" Label="实际负责人" Width="200px" Required="true" MaxLength="20" MaxLengthMessage="最多输入20个字符" CssClass="marginr" runat="server" TabIndex="12">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel24" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="AcceptUnit2" ShowLabel="true" Label="承担部门" MaxLength="20" MaxLengthMessage="最多输入20个字符" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="13">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                            ...
                            <Items>
                                <x:Panel ID="Panel6" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList AutoPostBack="false" Required="true" EnableSimulateTree="true" ShowLabel="false" TabIndex="14"
                                ...
                                <x:Panel ID="Panel14" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker runat="server" Required="true" Label="开始日期" EnableEdit="false" EmptyText="请选择开始日期" Width="195px" CssClass="marginr" TabIndex="15"
                                ...
                                <x:Panel ID="Panel31" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker ID="DatePickerEndTime" Required="true" EmptyText="请选择结束日期" CompareControl="DatePicker1" DateFormatString="yyyy-MM-dd"
                                ...
                                <x:Panel ID="Panel32" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DatePicker ID="DatePickerExpectEndTime" Required="true" EmptyText="请选择结束日期" CompareControl="DatePicker1" DateFormatString="yyyy-MM-dd"
                                ...
                                <x:Panel ID="Panel33" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList Label="预期成果" AutoPostBack="false" Required="true" EnableSimulateTree="true" TabIndex="18"
                                ...
                                <x:Panel ID="Panel23" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="GivenMoneyUnits2" ShowLabel="true" Label="来款单位" MaxLength="50" MaxLengthMessage="最多输入50个字符" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="19">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel21" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="ApprovedMoney2" ShowLabel="true" Label="项目经费" MaxLength="15" Regex="^\d+\.?\d+$|^\d+$" RegexMessage="只能输入数字" MaxLengthMessage="最多输入15个字符" Required="true" Width="200px" CssClass="marginr" runat="server" TabIndex="20">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel22" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:TextBox ID="GetMoney2" ShowLabel="true" Label="到账金额" MaxLength="15" Regex="^\d+\.?\d+$|^\d+$" RegexMessage="只能输入数字" Required="true" MaxLengthMessage="最多输入15个字符" Width="200px" CssClass="marginr" runat="server" TabIndex="21">
                                        </x:TextBox>
                                    </Items>
                                </x:Panel>
                                ...
                                <x:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                                    ...
                                    <Items>
                                        ...
                                        <x:DropDownList Label="保密等级" AutoPostBack="false" Required="true" EnableSimulateTree="true" TabIndex="23"
                        ...
                        <x:Panel ID="Panel15" ShowHeader="false" BodyPadding="30px" CssClass="formitem" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <x:DropDownList AutoPostBack="true" Required="true" ShowLabel="false" TabIndex="6"
                                ...
                                <x:DropDownList AutoPostBack="false" Required="true" EnableSimulateTree="true" ShowLabel="false"
        ...
        <asp:Panel ID="Panel5" ShowHeader="false" ShowBorder="false" ScrollBars="None"
            ...
            <asp:Label ID="Label18" runat="server" Label="Label" CssClass="marginr" Text=" " Width="30px" Visible="false">
            </asp:Label>
            <asp:Label ID="Label21" runat="server" Label="Label" CssClass="marginr" Text="经济效益相关文件： " Width="110px" Visible="false">
            </asp:Label>
            <input type="file" id="FileUploadFile" style="width: 200px" runat="server" visible="false" />
            <asp:Label ID="Label22" runat="server" Label="Label" CssClass="marginr" Text=" " Width="80px" Visible="false">
            </asp:Label>
            <asp:Label ID="Label23" runat="server" Label="Label" CssClass="marginr" Text="经费预算相关文件： " Width="110px" Visible="false">
            </asp:Label>
            <input type="file" id="FileUploadFileM" style="width: 200px" runat="server" visible="false" />
        </asp:Panel>
